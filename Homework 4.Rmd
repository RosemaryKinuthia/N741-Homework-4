...
Paste links together a series of strings (in this case x, y, z) while paste0 does not link a series of strings.
...
```
...
The Github repository for this assignment can be accessed via this link: (https://github.com/RosemaryKinuthia/N741-Homework-4.git) [https://github.com/RosemaryKinuthia/N741-Homework-4.git]
...
